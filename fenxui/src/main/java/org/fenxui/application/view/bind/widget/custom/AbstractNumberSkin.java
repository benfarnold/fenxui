...
import org.fenxui.application.view.bind.widget.custom.util.SkinnedTextInputValidationFilterChain;
import org.fenxui.application.view.bind.widget.custom.util.BigDecimalSkinnedNumberExtractor;
...
public abstract class AbstractNumberSkin extends JFXTextFieldSkin<SkinnableNumberField> {
	...
	protected void updateText(BigDecimal value) {
